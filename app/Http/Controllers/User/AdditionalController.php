...
class AdditionalController extends Controller
{
    ...
    public function resultWhoisLookup(Request $request)
    {
        ...
        return view('user.additional.whois-lookup', ['domain' => $domain, 'result' => $whoisRecords, 'settings' => $settings]);
    }
    ...
    public function resultDnsLookup(Request $request)
    {
        ...
        return view('user.additional.dns-lookup', ['domain' => $domain, 'results' => $dnsRecords, 'settings' => $settings]);
    }
    ...
    public function resultIpLookup(Request $request)
    {
        ...
        return view('user.additional.ip-lookup', ['content' => $request->input('content'), 'result' => $result, 'settings' => $settings]);
    }
}
