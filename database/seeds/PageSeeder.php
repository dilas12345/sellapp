...
class PageSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('pages')->insert([
            ...
            'section_content' => 'support@SellApp.co.in'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_content' => 'Privacy Policy for SellApp'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_content' => 'At SellApp, accessible from https://SellApp.goapps.online/, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by SellApp and how we use it.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'privacy',
            'section_title' => 'privacy_content_description',
            'section_content' => 'This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in SellApp. This policy is not applicable to any information collected offline or via channels other than this website.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'privacy',
            'section_title' => 'privacy_content_description',
            'section_content' => 'SellApp follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services analytics.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'privacy',
            'section_title' => 'privacy_content_description',
            'section_content' => 'Like any other website, SellApp uses cookies. These cookies are used to store information including visitors preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users experience by customizing our web page content based on visitors browser type and/or other information.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'privacy',
            'section_title' => 'privacy_content_description',
            'section_content' => 'You may consult this list to find the Privacy Policy for each of the advertising partners of SellApp.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'privacy',
            'section_title' => 'privacy_content_description',
            'section_content' => 'Note that SellApp has no access to or control over these cookies that are used by third-party advertisers.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'privacy',
            'section_title' => 'privacy_content_description',
            'section_content' => 'SellApps Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'privacy',
            'section_title' => 'privacy_content_description',
            'section_content' => 'SellApp does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_content' => 'Welcome to SellApp!'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'terms',
            'section_title' => 'term_content_description',
            'section_content' => 'These terms and conditions outline the rules and regulations for the use of SellApps Website, located at https://SellApp.goapps.online/.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'terms',
            'section_title' => 'term_content_description',
            'section_content' => 'By accessing this website we assume you accept these terms and conditions. Do not continue to use SellApp if you do not agree to take all of the terms and conditions stated on this page.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'terms',
            'section_title' => 'term_content_description',
            'section_content' => 'We employ the use of cookies. By accessing SellApp, you agreed to use cookies in agreement with the SellApps Privacy Policy.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'terms',
            'section_title' => 'term_content_description',
            'section_content' => 'Unless otherwise stated, SellApp and/or its licensors own the intellectual property rights for all material on SellApp. All intellectual property rights are reserved. You may access this from SellApp for your own personal use subjected to restrictions set in these terms and conditions.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'terms',
            'section_title' => 'term_content_description',
            'section_content' => 'Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. SellApp does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of SellApp,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, SellApp shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'terms',
            'section_title' => 'term_content_description',
            'section_content' => 'SellApp reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'terms',
            'section_title' => 'term_content_description',
            'section_content' => 'You hereby grant SellApp a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'terms',
            'section_title' => 'term_content_description',
            'section_content' => 'No use of SellApps logo or other artwork will be allowed for linking absent a trademark license agreement.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'refund',
            'section_title' => 'desc',
            'section_content' => 'Thank you for shopping at SellApp.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'refund',
            'section_title' => 'desc',
            'section_content' => '1. Company referred to as either the Company We, Us or Our in this Agreement) refers to SellApp, Chennai.'
        ]);
        ...
        DB::table('pages')->insert([
            ...
            'section_name' => 'refund',
            'section_title' => 'desc',
            'section_content' => '5. Website refers to SellApp, accessible from https://SellApp.goapps.online'
        ]);
