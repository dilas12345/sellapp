        ...
        <div class="container-xl">
            <div class="row row-deck row-cards">
                <div class="col-sm-12 col-lg-12">
                    <form action="{{ route('user.save.business.portfolio') }}" method="post" enctype="multipart/form-data"
                        class="card">
                        @csrf
                        {{-- Create Card --}}
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-7 col-xl-7">
                                    <div class="row">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="portfolio_color" type="radio" value="blue"
                                                    ...
                                                    <div class="col-auto">
                                                        <label class="form-colorinput form-colorinput-light">
                                                            <input name="portfolio_color" type="radio" value="indigo"
                                                    ...
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="portfolio_color" type="radio" value="green"
                                                                class="form-colorinput-input" required />
                                                    ...
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="portfolio_color" type="radio" value="yellow"
                                                                class="form-colorinput-input" required />
                                                    ...
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="portfolio_color" type="radio" value="red"
                                                                class="form-colorinput-input" required />
                                                    ...
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="portfolio_color" type="radio" value="purple"
                                                                class="form-colorinput-input" required />
                                                    ...
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="portfolio_color" type="radio" value="pink"
                                                                class="form-colorinput-input" required />
                                                    ...
                                                    <div class="col-auto">
                                                        <label class="form-colorinput form-colorinput-light">
                                                            <input name="portfolio_color" type="radio" value="gray"
                                                                class="form-colorinput-input" required />
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="portfolio_lang">{{ __('Language') }} <span
                                                        class="text-danger">*</span></label>
                                                <select name="portfolio_lang" id="portfolio_lang" class="form-control" required>
