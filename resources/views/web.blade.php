            ...
            <div class="flex flex-wrap items-center">
                <div class="w-full lg:w-1/2 mb-12 lg:mb-0">
                    <div class="max-w-md lg:mx-auto">
                        <span class="text-zinc-600 font-bold">{{ __($homePage[6]->section_content) }}</span>
                        ...
                        <ul class="text-gray-500 font-bold">
                            <li class="flex mb-4">
                                <svg class="mr-2 w-6 h-6 text-zinc-700" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="w-full lg:w-1/2 flex flex-wrap -mx-4">
                    <div class="mb-8 lg:mb-0 w-full md:w-1/2 px-4">
                        <div class="mb-8 py-6 pl-6 pr-4 shadow rounded bg-white">
                            <span class="mb-4 inline-block p-3 rounded-lg bg-slate-100">
                        ...
                        <div class="py-6 pl-6 pr-4 shadow rounded bg-white">
                            <span class="mb-4 inline-block p-3 rounded-lg bg-slate-100">
                                <svg class="w-10 h-10 text-slate-600" xmlns="http://www.w3.org/2000/svg"
                                    viewbox="0 0 20 20" fill="currentColor">
                                    <path
                    ...
                    <div class="w-full md:w-1/2 lg:mt-20 px-4">
                        <div class="mb-8 py-6 pl-6 pr-4 shadow rounded-lg bg-white">
                            <span class="mb-4 inline-block p-3 rounded bg-slate-100">
                                <svg class="w-10 h-10 text-slate-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewbox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="py-20 bg-gray-50 radius-for-skewed">
        <div class="container mx-auto px-4">
            <div class="mb-16 max-w-md mx-auto text-center">
                <span class="text-slate-600 font-bold">{{ __($homePage[20]->section_content) }}</span>
            ...
            <div class="flex flex-wrap -mx-4 shadow">
                <div class="mb-12 lg:mb-0 w-full md:w-1/2 lg:w-1/4 px-4 py-6 bg-white rounded ">
                    <span class="mb-4 md:mb-6 inline-block bg-slate-100 p-3 text-slate-500 rounded">
    ...
    <div class="py-20 bg-gray-50 radius-for-skewed">
        <div class="container mx-auto px-4">
            <div class="max-w-2xl mx-auto text-center mb-16">
                <span class="text-slate-600 font-bold">{{ __($homePage[46]->section_content) }}</span>
            ...
            <div class="flex flex-wrap justify-center items-center -mx-4">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8 lg:mb-0">
                    <div class="p-8 bg-slate-600 : 'white' }} shadow rounded">
                        <h4
                            class="mb-2 text-2xl font-bold {{ $plan->recommended == '1' ? 'text-back' : 'font-heading' }}">
                            {{ __($plan->plan_name) }}</h4>
                        <!--  -->
                        <span class="{{ $plan->recommended == '1' ? 'text-gray-500' : 'text-gray-500' }} text-xs">
                            ...
                            @endif
                        <p
                            class="mt-3 mb-6 {{ $plan->recommended == '1' ? 'text-gray-500' : 'text-gray-500' }} leading-loose">
                            {{ __($plan->plan_description) }}</p>
                        <ul class="mb-6 {{ $plan->recommended == '1' ? 'text-gray-500' : 'text-gray-500' }}">
                            <li class="mb-2 flex">
                                <svg class="mr-2 w-5 h-5 {{ $plan->recommended == '1' ? 'text-slate-400' : 'text-slate-600'}}"
                        ...
                        <a class="inline-block text-center py-2 px-4 w-full rounded-l-xl rounded-t-xl {{ $plan->recommended == '1' ? 'bg-white hover:bg-blue-100' : 'bg-blue-600 hover:bg-blue-700 text-white'}} font-bold leading-loose transition duration-200"
