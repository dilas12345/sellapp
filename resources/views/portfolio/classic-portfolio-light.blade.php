...
<head>
    ...
    {!! Twitter::generate() !!}
    {!! JsonLd::generate() !!}
    <link rel="stylesheet" href="{{asset ('frontend/portfolio/assets/css/main.css')}}">
</head>
<body>
	...
	<script>window.jQuery || document.write('<script src="{{asset ('frontend/portfolio/assets/js/vendor/jquery-2.2.4.min.js')}}"><\/script>')</script>
	<script src="{{asset('frontend/profolio/assets/js/functions-min.js')}}"></script>
